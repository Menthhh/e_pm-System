        ...
        <Layout className="container flex flex-col left-0 right-0 mx-auto justify-start font-sans mt-2 px-6">
            <div className="flex flex-col items-start gap-4 mb-4 p-4 bg-white ">
                <div className="flex items-center gap-4">
                    <Image src="/assets/card-logo/profile.png" alt="wd logo" width={50} height={50} />
                    <h1 className="text-3xl font-bold text-slate-900">Edit User Profile</h1>
                </div>
                <h1 className="text-sm font-bold text-secondary flex  items-center">Edit user information, adding profile image.</h1>
            </div>
            <form onSubmit={handleSubmit}>
                ...
                <h1 className="text-3xl font-bold text-primary flex items-center cursor-pointer" >
                    ...
                    {isShowUserImage ?
                        <ArrowDropUpIcon style={{ fontSize: "5rem" }} onClick={toggleUserImage} /> :
                        <ArrowDropDownIcon style={{ fontSize: "5rem" }} onClick={toggleUserImage} />
                    }
                </h1>

                <div className={`flex flex-col gap-4 justify-center items-center mb-10 ${isShowUserImage ? "" : "hidden"}`}>
                    <div
                        {...getRootProps()}
                ...
                <h1 className="text-3xl font-bold text-primary flex items-center cursor-pointer" >
                    Edit Information
                    {isShowUserInfo ?
                        <ArrowDropUpIcon style={{ fontSize: "5rem" }} onClick={toggleUserInfo} /> :
                        <ArrowDropDownIcon style={{ fontSize: "5rem" }} onClick={toggleUserInfo} />
                    }
                </h1>
                ...
                <h1 className="text-3xl font-bold text-primary flex items-center cursor-pointer" >
                    Edit Password
                    {isShowPassword ?
                        <ArrowDropUpIcon style={{ fontSize: "5rem" }} onClick={togglePassword} /> :
                        <ArrowDropDownIcon style={{ fontSize: "5rem" }} onClick={togglePassword} />
                    }
                </h1>
                {/* Password and Confirm Password */}
                <div className={`mb-6 grid grid-rows-2 ${isShowPassword ? "" : "hidden"}`}>
                    <div className="mb-6">
                    ...
                    <div className="-translate-y-2">
                        <input
                            ...
                            className="mr-2"
                        />
                        <label htmlFor="togglePassword" className="text-sm text-gray-900 dark:text-white">
                            Show passwords
                        </label>
                    </div>
                </div>
