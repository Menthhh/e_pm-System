...
const ShowmoreData = ({ data, close }) => {
  ...
  return (
    <div className="w-1/2 h-full max-h-[80vh] bg-white p-6 rounded-lg shadow-lg overflow-y-auto relative" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none', WebkitScrollbar: 'none' }}>
