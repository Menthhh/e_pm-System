...
export default function LoginForm() {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col items-center justify-center container font-sans shadow-2xl drop-shadow-2xl w-8/12 ipadmini:w-4/12  rounded-xl shadow-lg "
      ...
      >
        ...
        <div className="flex flex-col items-center gap-10 bg-white p-10 w-full relative pb-24 rounded-b-lg">
          <Image src="/assets/images/login-logo.png" alt="person" width={100} height={100} />
          <form className="flex flex-col items-center gap-5 " action={formAction}>
            ...
            <div className="flex items-center self-start -translate-y-1">
              ...
              />
              <label htmlFor="showPassword" className="ml-2 text-sm text-gray-900 dark:text-gray-400">
                Show Password
              </label>
            </div>
          ...
          <Link href="/pages/forgot-password" className="underline text-sm cursor-pointer hover:text-gray-400 absolute left-2 bottom-2">
            Forgot Password?
          </Link>
        </div>
      </div>
