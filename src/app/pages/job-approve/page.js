    ...
    <Layout className="container flex flex-col left-0 right-0 mx-auto justify-start font-sans mt-2 px-6 ">
      <div className="flex flex-col items-start gap-4 mb-4 p-4 bg-white ">
        <div className="flex items-center gap-4">
          <Image src="/assets/card-logo/approve.png" alt="wd logo" width={50} height={50} />
          <h1 className="text-3xl font-bold text-slate-900">ChecklistPM-Approval</h1>
        </div>
        <h1 className="text-sm font-bold text-secondary flex  items-center">Approve/Disapprove Checklist.</h1>
      </div>
      <h1 className="text-md font-bold text-secondary flex  items-center">
        There are {jobApproves.length} submitted jobs, that you need to be reviewed.
      </h1>
