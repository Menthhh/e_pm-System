...
export default function RegisterForm() {
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-blue-500">
      <div className="flex flex-col shadow-lg pb-5 rounded-3xl bg-white ">
        <h1 className="text-4xl font-bold text-center bg-blue-600 p-4 text-gray-100 rounded-t-3xl w-full">
          e_pm
        </h1>
        <h2 className="text-2xl font-bold text-center py-4 ">Register</h2>
        <form
          ref={formRef}
          className="flex flex-col justify-center items-center gap-5 px-10" action={formAction}>
