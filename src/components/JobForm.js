...
import WebcamEditted from './WebcamEditted';
                    ...
                    <table className="table-auto border-collapse w-full text-sm">
                        <thead className="text-center">
                            <tr className="bg-gray-200">
                                ...
                                <th className="w-[150px] px-4 py-2">Add images</th>
                            </tr>
                        </thead>
                        <tbody className="text-center">
                            {jobItems.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="border px-4 py-2 relative">
                                        <button type="button" onClick={handleAddImages} className="bg-primary text-white rounded-md px-2 py-1">Add Images</button>
                                    </td>
